...
# 🌸🌿 FENRYS BOT V2 - SUA CONEXÃO SUAVE E ENCANTADORA 🌿🌸
...
# 🌸 Apresentação do Fenrys Bot V2
while true; do
    if ! verificar_conexao; then
        clear
        echo_color "pink"  "****************************************************"
        echo_color "gold"  " 💕✨ Bem-vinda ao Fenrys Bot V2! ✨💕"
        echo_color "pink"  "****************************************************"
        echo ""
        ...
        if [ -z "$opcao" ]; then
            ...
            case $opcao in
                ...
                5|5️⃣)
                    ...
                    ;;
                6|6️⃣)
                    echo_color "red" "👋 Obrigada por usar o FENRYS BOT V2! Até logo! 🌿✨"
                    exit 0
                    ;;
                *)
